...
ActiveRecord::Schema.define(:version => 20100722095330) do
  ...
  create_table "devices_versions", :id => false, :force => true do |t|
    t.integer "device_id"
  ...
  create_table "registers_servers", :id => false, :force => true do |t|
    t.integer "register_id"
    t.integer "server_id"
  end
